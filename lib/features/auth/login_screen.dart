...
class LoginScreen extends StatelessWidget {
  ...
  final email = PreferencesManager().getString("key_email");
   final password = PreferencesManager().getString("key_password");
   ...
   if(email == null || password == null) {
    ...
    if (emailController.text == email && passWordController.text == password) {
      PreferencesManager().setBool('key_logged_in_screen', true);
